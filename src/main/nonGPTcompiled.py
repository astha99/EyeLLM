...
from src.main.responseGenerator import (
    generate_llm_responses_hf, generate_llm_responses_with_fixated_words_hf,
    generate_llm_responses_with_fixated_sentences_hf
)
...
for iteration in range(1, num_iterations + 1):
    ...
    for json_file in json_files:
        ...
        for entry in fixated_data:
            ...
            responses = {
                "Pretext Only": generate_llm_responses_hf(student_prompt, student_completion, entry['pretext0'], model_name),
                "Pretext + Words": generate_llm_responses_with_fixated_words_hf(student_prompt, student_completion,
                                                                             entry['pretext0'], entry["fixated_words"], model_name),
                "Pretext + Sentences": generate_llm_responses_with_fixated_sentences_hf(student_prompt, student_completion,
                                                                                     entry['pretext0'],
                                                                                     entry["fixated_sentences"], model_name),
                "Control": generate_llm_responses_with_fixated_words_hf(student_prompt, student_completion, entry['pretext0'],
                                                          entry["non_fixated_words"], model_name)
            }
